        ...
        <div className=" py-20 bg-gray-50 p-4">
            <div className="max-w-3xl mx-auto   p-6 lg:p-10 bg-white shadow-sm rounded-lg">
                ...
                <form onSubmit={handleAddBookSubmit} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        className="w-full bg-blue-800 text-white py-2 px-4 rounded-md hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                    >
                        Add Book
                    </button>
                </form>
